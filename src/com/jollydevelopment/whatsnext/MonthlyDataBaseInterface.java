...
public class MonthlyDataBaseInterface extends SQLiteOpenHelper {
	//Constants
	//database version
	private static final int DATABASE_VERSION = 1;
	//database name
	private static final String DATABASE_NAME = "com.jollydevelopment.whatsnext.monthly.db";
	//table name
	public static final String TABLE_NAME_TASKS = "monthly_tasks";
	//column names
	...
	public MonthlyDataBaseInterface(Context context) {
	...
	/*
	 * Method: getAllTasks() This will query the database, get the information for each row,
