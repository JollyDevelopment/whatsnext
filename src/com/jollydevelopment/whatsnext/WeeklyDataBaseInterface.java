...
public class WeeklyDataBaseInterface extends SQLiteOpenHelper {
	//Constants
		//database version
		private static final int DATABASE_VERSION = 1;
		//database name
		private static final String DATABASE_NAME = "com.jollydevelopment.whatsnext.weekly.db";
		//table name
		public static final String TABLE_NAME_TASKS = "weekly_tasks";
		//column names
		...
		public WeeklyDataBaseInterface(Context context) {
